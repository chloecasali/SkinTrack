...
export const resources = {
  ...
  fr: {
    translation: {
      ...
      calendar: {
        todaySubtitle: "Une vue plus claire des étapes qui comptent.",
        stepsLabel: "Étapes",
        stepsTitle: "Routine du jour",
        completedLabel: "Terminé",
        shareTitle: "Partagez votre expérience.",
        shareBody:
          "Explorez les routines douces d'autres utilisateurs et comparez ce qui garde leur peau équilibrée.",
        explore: "Explorer",
